                    ...
                    <td class="text-end pe-4">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end glass-card border-0">
                                <li>
                                    <form action="<?php echo BASE_URL; ?>agency/reservations/update_status" method="POST">
                                ...
                                <li>
                                    <form action="<?php echo BASE_URL; ?>agency/reservations/update_status" method="POST">
                                        <input type="hidden" name="id" value="<?php echo $res['id']; ?>">
                                        <button type="submit" name="status" value="cancelada" class="dropdown-item text-danger">
