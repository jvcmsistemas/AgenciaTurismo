...
<div class="row mb-4 fade-in">
    <div class="col-12">
        <h2 class="fw-bold text-primary"><i class="bi bi-person-plus me-2"></i>Registrar Nuevo Cliente</h2>
        <p class="text-muted">Añade un nuevo viajero a tu cartera.</p>
    </div>
</div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" id="nombre" name="nombre" required
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-light border-end-0"><i
                                class="bi bi-person text-secondary"></i></span>
                        <input type="text" class="form-control border-start-0" id="apellido" name="apellido" required
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" id="ruc" name="ruc"
                            placeholder="Si requiere factura">
                    </div>
                </div>
            </div>
        </div>
