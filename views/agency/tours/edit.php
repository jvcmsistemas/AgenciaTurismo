    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-primary fw-bold mb-0">Editar Tour</h2>
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" required
                                value="<?php echo htmlspecialchars($tour['nombre']); ?>">
                        </div>

                        <div class="col-md-12">
                            <label for="descripcion" class="form-label fw-bold text-muted small">DESCRIPCIÓN</label>
                            <textarea class="form-control" id="descripcion" name="descripcion"
                                rows="4"><?php echo htmlspecialchars($tour['descripcion']); ?></textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="ubicacion" name="ubicacion"
                                value="<?php echo htmlspecialchars($tour['ubicacion']); ?>">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="precio" name="precio" min="0" step="0.01"
                                required value="<?php echo $tour['precio']; ?>">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="nivel_dificultad" name="nivel_dificultad">
                                <option value="bajo" <?php echo $tour['nivel_dificultad'] === 'bajo' ? 'selected' : ''; ?>>Bajo</option>
                                <option value="medio" <?php echo $tour['nivel_dificultad'] === 'medio' ? 'selected' : ''; ?>>Medio</option>
                                <option value="alto" <?php echo $tour['nivel_dificultad'] === 'alto' ? 'selected' : ''; ?>>Alto</option>
                            </select>
                        </div>
