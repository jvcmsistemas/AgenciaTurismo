...
switch ($path) {
    ...
    case 'admin/support/reply':
        ...
        $controller->reply();
        break;
    case 'admin/support/updateStatus':
        require_once BASE_PATH . '/controllers/SupportController.php';
        $controller = new SupportController($pdo);
    ...
    // FAQ Management
    case 'admin/support/faqs':
        require_once BASE_PATH . '/controllers/SupportController.php';
        $controller = new SupportController($pdo);
        $controller->faqsIndex();
        break;
    case 'admin/support/faqs/create':
        require_once BASE_PATH . '/controllers/SupportController.php';
        $controller = new SupportController($pdo);
        $controller->createFaq();
        break;
    case 'admin/support/faqs/store':
        require_once BASE_PATH . '/controllers/SupportController.php';
        $controller = new SupportController($pdo);
        $controller->storeFaq();
        break;
    case 'admin/support/faqs/edit':
        require_once BASE_PATH . '/controllers/SupportController.php';
        $controller = new SupportController($pdo);
        $controller->editFaq();
        break;
    case 'admin/support/faqs/update':
        require_once BASE_PATH . '/controllers/SupportController.php';
        $controller = new SupportController($pdo);
        $controller->updateFaq();
        break;
    case 'admin/support/faqs/delete':
        require_once BASE_PATH . '/controllers/SupportController.php';
        $controller = new SupportController($pdo);
    ...
    case 'agency/audit':
        require_once BASE_PATH . '/controllers/AgencyAuditController.php';
        $controller = new AgencyAuditController($pdo);
        $controller->index();
        break;

    // --- CONFIGURACIÓN DE AGENCIA ---
    case 'agency/settings':
        require_once BASE_PATH . '/controllers/AgencySettingsController.php';
        $controller = new AgencySettingsController($pdo);
        $controller->index();
        break;
    case 'agency/settings/update':
        require_once BASE_PATH . '/controllers/AgencySettingsController.php';
        $controller = new AgencySettingsController($pdo);
        $controller->update();
        break;
