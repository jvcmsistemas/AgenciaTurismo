...
class Departure
{
    ...
    {
        $sql = "INSERT INTO salidas (agencia_id, tour_id, fecha_salida, hora_salida, guia_id, transporte_id, cupos_totales, cupos_disponibles, precio_actual, costo_guia, costo_transporte, costo_otros, estado) 
                VALUES (:agencia_id, :tour_id, :fecha_salida, :hora_salida, :guia_id, :transporte_id, :cupos_totales, :cupos_disponibles, :precio_actual, :costo_guia, :costo_transporte, :costo_otros, :estado)";
