...
class AdminController
{
    ...
    public function index()
    {
        ...
        // 3. Ingresos Mensuales Reales (KPI)
        $currentMonth = date('Y-m');
        $stmt = $this->pdo->prepare("SELECT SUM(monto) FROM pagos WHERE DATE_FORMAT(fecha_pago, '%Y-%m') = :mes AND estado = 'aprobado'");
        ...
        // 7. Datos de ingresos de los últimos 6 meses para el gráfico
        $stmt = $this->pdo->query("
