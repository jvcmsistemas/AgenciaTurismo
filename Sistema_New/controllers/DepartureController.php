    ...
    public function store()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $data = [
                ...
                'costo_guia' => !empty($_POST['costo_guia']) ? $_POST['costo_guia'] : 0,
                'costo_transporte' => !empty($_POST['costo_transporte']) ? $_POST['costo_transporte'] : 0,
                'costo_otros' => !empty($_POST['costo_otros']) ? $_POST['costo_otros'] : 0,
                'estado' => 'programada'
            ];
