        ...
        <div class="col-lg-9">
            ...
            <div id="invoice-content" class="bg-white shadow-lg mx-auto"
                ...
                <div class="d-flex justify-content-between align-items-start mb-4 mt-2">
                    <!-- Parte Izquierda: Logo e Info Agencia -->
                    ...
                    <!-- Parte Derecha: Info de la Reserva -->
                    ...
                    <table class="table table-borderless table-striped mb-0"
                        ...
                        <thead style="background-color: #00695c; color: white;">
                            <tr>
                                ...
                                <th class="py-2 text-end" style="font-weight: 500; font-size: 9.5pt;">PRECIO UNIT.
                                </th>
                    ...
                    <div class="col-7">
                        <?php if (!empty($reservation['notas'])): ?>
                            <div class="bg-light p-3 rounded" style="font-size: 9pt; border-left: 4px solid #00695c;">
                                ...
                                <p class="mb-0 text-muted"><?php echo nl2br(htmlspecialchars($reservation['notas'])); ?>
                                </p>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="card border-0 shadow-sm mt-4 mb-5 no-print bg-surface-dynamic">
                <div
                    ...
                    <h5 class="fw-bold text-dynamic mb-0"><i class="bi bi-cash-coin me-2 text-success"></i>Historial
                        de
                        Pagos</h5>
