...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4 align-items-center report-header">
        <div class="col-md-6 d-flex align-items-center">
            <?php if (!empty($agency['logo_url'])): ?>
                <img src="<?php echo htmlspecialchars($agency['logo_url']); ?>" alt="Logo" class="me-3"
                    style="max-height: 60px; max-width: 120px; object-fit: contain;">
            <?php endif; ?>
            <div>
                <h2 class="fw-bold mb-0 text-dynamic">
                    <i class="bi bi-graph-up-arrow me-2 text-primary no-print"></i>Rentabilidad por Salida
                </h2>
                <p class="text-muted-dynamic mb-0"><?php echo htmlspecialchars($agency['nombre']); ?> - Análisis
                    detallado.</p>
            </div>
        </div>
        <div class="col-md-6 text-end">
            ...
            <div class="d-none d-print-block">
                <p class="mb-0 small text-muted">Generado el: <?php echo date('d/m/Y H:i'); ?></p>
                <p class="mb-0 small text-muted">Periodo: <?php echo date('d/m/Y', strtotime($startDate)); ?> al
                    <?php echo date('d/m/Y', strtotime($endDate)); ?></p>
            </div>
        </div>
    </div>
                            ...
                            <tr class="border-dynamic">
                                ...
                                <td class="text-center pe-4">
                                    <span class="badge bg-soft-dynamic text-dynamic border small info-popover"
                                        ...
                                        data-bs-content="<div class='small'><strong>Guía (Salida):</strong> <?php echo formatCurrency($r['costo_guia']); ?><br><strong>Transporte (Salida):</strong> <?php echo formatCurrency($r['costo_transporte']); ?><br><strong>Gastos Operativos (Tabla):</strong> <?php echo formatCurrency($r['total_gastos_tabla']); ?><br><strong>Otros:</strong> <?php echo formatCurrency($r['costo_otros']); ?></div>"
                                        data-bs-html="true">
