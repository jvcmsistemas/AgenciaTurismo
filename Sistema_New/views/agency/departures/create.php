                ...
                <div class="card-body p-4">
                    <form action="<?php echo BASE_URL; ?>agency/departures/store" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <h5 class="fw-bold text-dark mb-3"><i class="bi bi-info-circle me-2 text-success"></i>4.
                                Detalles Finales</h5>
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-muted small">CAPACIDAD TOTAL (PAX)</label>
                                    <div class="input-group">
                                        <span
                                            class="input-group-text bg-light-dynamic border-end-0 border-dynamic text-primary"><i
                                                class="bi bi-people"></i></span>
                                        <input type="number"
                                            class="form-control border-start-0 border-dynamic bg-dynamic"
                                            name="cupos_totales" id="cupos_totales" required placeholder="Ej: 15">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-muted small">PRECIO ESPECIAL
                                        (OPCIONAL)</label>
                                    <div class="input-group">
                                        <span
                                            class="input-group-text bg-light-dynamic border-end-0 border-dynamic text-primary"><?php echo CURRENCY_SYMBOL; ?></span>
                                        <input type="number" step="0.01"
                                            class="form-control border-start-0 border-dynamic bg-dynamic"
                                            name="precio_actual" placeholder="Precio del tour por defecto">
                                    </div>
                                </div>
                            </div>
